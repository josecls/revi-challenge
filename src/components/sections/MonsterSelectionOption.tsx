...
const MonsterSelectionOption = ({
  ...
  return (
    <Button
      className="mt-13 p-0 bg-transparent hover:bg-transparent"
      onClick={onClick}
    >
      <HoverCard>
        <HoverCardTrigger className="cursor-pointer">
          <Avatar
            className={`w-16 h-16 md:w-20 md:h-20 border-4 ${borderColor}`}
          >
            <AvatarImage
        ...
        <HoverCardContent className="w-40 p-4 bg-white shadow-md">
          <h2 className="text-lg font-bold font-[fredoka] mb-2">
            {monster.name}
          </h2>
