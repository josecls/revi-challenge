...
export default function Home() {
    ...
    return (
        ...
        <main className="flex flex-col items-center text-center gap-20">
            ...
            <button className="bg-green-500 hover:bg-green-600 text-2xl font-bold py-3 px-10 rounded-xl transition-transform duration-300 transform hover:scale-105 cursor-pointer" onClick={handleStart}>
            explore
            </button>
        </main>
